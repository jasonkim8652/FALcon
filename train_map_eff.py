...
from libs.io_utils_eff import get_dataset
from libs.io_utils_eff import MyDataset
from libs.io_utils_eff import smi_collate_fn
...
def main(args):
    ...
    for epoch in range(args.num_epoches):
        ...
        for i, batch in enumerate(train_loader):
            ...
            y = y.to(device)
            y = y.float()
            pred, alpha = model(graph1, graph2, training=True)
            y_list.append(y)
